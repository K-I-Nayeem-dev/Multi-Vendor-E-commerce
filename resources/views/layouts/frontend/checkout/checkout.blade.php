                ...
                <div class="container">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-lg-3 col-md-3 col-sm-12">
                            ...
                            <ul class="header_icons_group ul_li_right list-unstyled">
                                <li>
                                    <button type="button" class="cart_btn">
                                        <span class="cart_icon">
                                            ...
                                            @auth
                                                <small
                                                    class="cart_counter">{{ App\Models\Wishlist::Where('user_id', auth()->id())->count() }}</small>
                                            @endauth
                                        </span>
                                    </button>
                                </li>
                    ...
                    <div class="row align-items-center">
                            ...
                            <nav class="main_menu navbar navbar-expand-lg">
                                <div class="main_menu_inner collapse navbar-collapse" id="main_menu_dropdown">
                                    ...
                                    <ul class="main_menu_list ul_li">
                                        ...
                                        <li><a class="nav-link" href="{{ route('frontend_about') }}">About us</a>
                                        </li>
                                        <li><a class="nav-link" href="#">Shop</a></li>
                                        <li><a class="nav-link" href="{{ route('frontend_contact') }}">Contact Us</a>
                                        </li>
                                        @auth
                                            <li>
                        ...
                        <div class="col col-md-3">
                            <ul class="header_icons_group ul_li_right">
                                    ...
                                    <li>
                                        @if (Auth::user()->profile_photo)
                                            <img src="{{ asset('uploads/profile_photo') }}/{{ Auth::user()->profile_photo }}"
                                                class="img-fluid rounded-circle" alt="" width="50"
                                                height="50">
                                        @else
                                            <a href="#">
                                ...
                                @guest
                                    <li>
                                        <a class="btn btn-primary btn-sm text-white" style="font-size: 12px;"
                                            href="{{ route('account_registration') }}">Login/Registration</a>
                                    </li>
                                @endguest
