<main>
    ...
    <section class="cart_section section_space">
        @auth
                                    ...
                                    <tr>
                                        ...
                                        @if ($cart->color != 'null')
                                            <td class="text-center" style="font-size: 12px"><span
                                                    class="price_text text-white py-2 px-4 rounded"
                                        ...
                                        <td class="text-center"><span
                                            ...
                                            @php
                                                ...
                                                $sub_total = !session()->has('coupon')
                                                    ? $total_price + $vat
                                                    : $total_price + $vat - session()->get('coupon')['discount'];
                            ...
                            @if ($coupons > 0)
                                <div class="col col-lg-6">
                                    @if (session()->has('coupon'))
                                        <span
                                            class="text-success mt-2 fs-6">{{ session()->get('coupon')['message'] }}</span><button
                                            wire:click='coupon_remove' class="text-danger fs-6 btn-sm">Remove</button>
                                            ...
                                            <div class="coupon_form form_item mb-0">
                                                ...
                                                <div class="info_icon">
                                                    <i class="fas fa-info-circle" data-bs-toggle="tooltip"
                                                        data-bs-placement="top" title="Your Info Here"></i>
                                                </div>
                                            </div>
                                            @error('coupon')
            ...
            @else
                <div class="text-center"><h2>No Product added to cart</h2></div>
            @endif
            @elseguest
