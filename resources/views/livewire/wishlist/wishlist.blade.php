<div class="sidebar-menu-wrapper">
    <div class="cart_sidebar">
        ...
        <ul class="cart_items_list ul_li_block mb_30 clearfix">
            @foreach (App\Models\Wishlist::Where('user_id', auth()->id())->get() as $cart)
                <li>
                    ...
                    <div class="item_content">
                        ...
                        <span class="item_price">{{ $cart->rel_to_product->discount_price }} x
                            {{ $cart->quantity }}</span>
                    </div>
                    <div class="item_content">
                        <span class="item_price">Variation:{{ $cart->size }}</span>
                    </div>
                    <button type="button" class="remove_btn" wire:click="removeItem({{ $cart->id }})"><i
